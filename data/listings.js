...
(function (SP) {
  ...
  SP.data.listingRules = {
    ...
    units: [
      ...
      { unit: 'TT-01',        from: 'eveandboy', excludeTypes: ['type-palette', 'type-toner-pad'] },
      { unit: 'TT-02',        from: 'eveandboy', excludeTypes: ['type-palette', 'type-toner-pad'] },
      { unit: 'TT-03',        from: 'eveandboy', excludeTypes: ['type-palette', 'type-toner-pad'] },
      { unit: 'TT-04',        from: 'eveandboy', excludeTypes: ['type-palette', 'type-toner-pad'] },
